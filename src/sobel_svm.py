#Implementing Sobel edge detection+CLAHE to better amplify the tortuosity of the blood vessels.
#extract Sobel edge features from retinal images,
# aggregate per patient/series, train an SVM to classify ROP vs Normal.
...
def train_and_evaluate(base_dir, csv_path, out_model=out_model, out_scaler=out_scaler):
    ...
    #map diagnosis code (dg_code) to binary label 'ROP' or 'Normal'
    ...
    y = agg['label'].values               # sample-level labels
